...
ครึ่งหลังเดือนพฤษจิกายนเข้าไปแล้ว ไปลอยกระทงที่ไหนดีหว่าเนี้ย ฤดูหนาวคราวนี้ไม่ค่อยจะหนาวเท่าไรเลยแหะ สงสัยเก็บไว้หนาวปีใหม่

ในที่สุดก็ได้ online ไปกับ node.js แบบจริงจัง งานนี้ยากเหมือนอย่างที่คิดไว้เลย เหอๆๆ

ได้เทคนิคของ node.js มาเยอะเลย ช่วงลุยโปรเจ็คคราวนี้
